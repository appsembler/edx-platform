...
class RecalculateSubsectionGradeTest(HasCourseWithProblemsMixin, ModuleStoreTestCase):
    ...
    @ddt.data(
        (ModuleStoreEnum.Type.mongo, 1, 43, True),
        (ModuleStoreEnum.Type.mongo, 1, 43, False),
    ...
    @ddt.data(
        (ModuleStoreEnum.Type.mongo, 1, 43),
        (ModuleStoreEnum.Type.split, 2, 43),
    )
    @ddt.unpack
    ...
    @ddt.data(
        (ModuleStoreEnum.Type.mongo, 1, 44),
        (ModuleStoreEnum.Type.split, 2, 44),
    )
    @ddt.unpack
