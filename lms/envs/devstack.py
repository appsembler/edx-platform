...
########################## Courseware Search #######################
FEATURES['ENABLE_COURSEWARE_SEARCH'] = FEATURES.get('ENABLE_COURSEWARE_SEARCH', False)
FEATURES['ENABLE_COURSEWARE_SEARCH_FOR_COURSE_STAFF'] = FEATURES.get('ENABLE_COURSEWARE_SEARCH_FOR_COURSE_STAFF', True)
SEARCH_ENGINE = 'search.elastic.ElasticSearchEngine'


########################## Dashboard Search #######################
FEATURES['ENABLE_DASHBOARD_SEARCH'] = FEATURES.get('ENABLE_DASHBOARD_SEARCH', False)
...
FEATURES['ENABLE_COURSE_DISCOVERY'] = FEATURES.get('ENABLE_COURSE_DISCOVERY', False)
