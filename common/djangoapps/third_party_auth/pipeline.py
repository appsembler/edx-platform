...
@partial.partial
def login_analytics(strategy=None, backend=None, pipeline_index=None, current_partial=None, auth_entry=None, *args, **kwargs):  # lint-amnesty, pylint: disable=keyword-arg-before-vararg
